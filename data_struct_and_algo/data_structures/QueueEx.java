...
public class QueueEx {
	public static void main(String[] args) {
		...
		/*
		 * here why we do not create a constructor for the queue because Queue itself is
		 * a interface and this interface is implemented by the LinkedList class so we
		 * use this. and Queue is also implemented by the PriorityQueue but it has
		 * different properties
		 * 
		 * it is a FIFO -> First in First out it have the head and tail.
		 */
		...
		System.out.println(queue.contains("Adityaa"));
